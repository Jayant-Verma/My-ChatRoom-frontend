...
const ChatRoom = () => {
    ...
    useEffect(() => {
        const socket = io("https://nodeserverforchatapp.herokuapp.com/");
        setSocket(socket);
    ...
    return (
        <div className="py-4 m-5 w-80 shadow bg-white text-dark border rounded container">
                ...
                {allMessages.map((msg) => {
                    return data.name === msg.name ? (
                        <div className="row justify-content-end pl-5">
                            <div className="d-flex flex-column align-items-end m-2 shadow p-2 bg-info text-white border rounded w-auto">
                                <div>
                        ...
                        <div className="row justify-content-start">
                            <div className="d-flex flex-column m-2 p-2 shadow bg-white text-secondary border rounded w-auto">
                                <div>
                                    <strong className="m-1">{msg.name}</strong>
